...
send "echo 'Versa@123!!' | sudo -S timeout 30 docker run --rm -v /dev/infiniband:/dev/infiniband -v /tmp:/tmp --net=host --privileged mellanox/tcpdump-rdma tcpdump -i ${device} -nn -w /tmp/${pcap_file} 'udp'\\r"
expect {
    "packets captured" {
