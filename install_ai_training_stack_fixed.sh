...
HOROVOD_WITH_PYTORCH=1 HOROVOD_WITH_MPI=1 pip3 install --break-system-packages horovod[pytorch]

# Verify installations
echo ""
echo "=== Verification ==="
python3 --version
python3 -c "import torch; print(f'PyTorch: {torch.__version__}')" 2>/dev/null || echo "PyTorch: Installation in progress..."
python3 -c "import horovod.torch as hvd; print('Horovod: OK')" 2>/dev/null || echo "Horovod: Installation in progress..."
...
echo ""
echo "Next: Copy training script and set up distributed training"
