...
echo ""
echo "  1. echo '<PASSWORD>' | sudo -S apt-get update && apt-get install -y lldpad"
echo "  2. echo '<PASSWORD>' | sudo -S systemctl start lldpad"
echo "  3. echo '<PASSWORD>' | sudo -S systemctl enable lldpad"
echo "  4. echo '<PASSWORD>' | sudo -S lldptool -T -i ens192 -V PFC enableTx=yes"
echo "  5. echo '<PASSWORD>' | sudo -S lldptool -i ens192 -T -V PFC -c enabled=0,0,0,1,0,0,0,0"
echo "  6. echo '<PASSWORD>' | sudo -S lldptool set-lldp -i ens192 adminStatus=rxtx"
echo "  7. echo '<PASSWORD>' | sudo -S ethtool -a ens192"
echo ""
