...
echo ""
echo "watch -n 1 'sshpass -p \"Versa@123!!\" ssh admin@192.168.50.229 \"show queuing interface ethernet1/1/1\" | grep -E \"Ingress MMU Drop|WRED Drop|Tx Pkts\"'"
echo ""
echo "What to watch:"
...
echo "Run this on your local machine:"
echo ""
echo "watch -n 1 'sshpass -p \"Versa@123!!\" ssh admin@192.168.50.229 \"show interface priority-flow-control | grep -E \\\"Ethernet1/1|ii1/1\\\"\"'"
echo ""
echo "What to watch:"
...
echo "Run this on your local machine:"
echo ""
echo "watch -n 1 'sshpass -p \"Versa@123!!\" ssh versa@192.168.11.107 \"rdma statistic show link rocep11s0/1 | grep -E \\\"cnp|ecn\\\"\"'"
echo ""
echo "What to watch:"
