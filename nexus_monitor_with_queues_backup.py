                ...
                with data_lock:
                    for qos_group, rates in queue_rates.items():
                        if qos_group in interface_data[interface]['queues']:
                            ...
                            q_data['tx_bytes'].append(round(rates['tx_bps'] / 1_000_000, 2))  # Mbps
                            q_data['dropped_pkts'].append(round(rates['drop_pps'], 2))
                            q_data['current_tx_pkts'] = round(rates['tx_pps'], 2)
                            q_data['current_tx_bytes'] = round(rates['tx_bps'] / 1_000_000, 2)
                            ...
                            <div class="interface-section">
                                ...
                                <div class="grid">
                                    <div class="card">
                                        ...
                                        <div class="stats">
                                            <div>RX: <span class="stat-value" style="color: #10b981;">${ifaceData.current_rx.toFixed(2)} Mbps</span></div>
                                            <div>TX: <span class="stat-value" style="color: #f59e0b;">${ifaceData.current_tx.toFixed(2)} Mbps</span></div>
                                        </div>
